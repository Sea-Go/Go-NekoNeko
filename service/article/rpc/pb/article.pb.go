...
func (x *CreateArticleRequest) GetMarkdownContent() string {
	if x != nil {
		return x.MarkdownContent
	}
	return ""
...
func (x *UpdateArticleRequest) GetMarkdownContent() string {
...
const file_proto_article_proto_rawDesc = "" +
	...
	"\aarticle\x18\x01 \x01(\v2\x10.article.ArticleR\aarticle\"\xad\x03\n" +
