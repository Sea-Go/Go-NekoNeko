...
const (
	...
	ArticleService_LikeArticle_FullMethodName   = "/article.ArticleService/LikeArticle"
)
...
func (c *articleServiceClient) ListArticles(ctx context.Context, in *ListArticlesReq, opts ...grpc.CallOption) (*ListArticlesResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedArticleServiceServer) ListArticles(context.Context, *ListArticlesReq) (*ListArticlesResp, error) {
...
func _ArticleService_ListArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).ListArticles(ctx, req.(*ListArticlesReq))
	}
	return interceptor(ctx, in, info, handler)
}
